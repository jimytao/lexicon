...
### Windows
- **[Lexicon_0.9.14_x64-setup.exe](https://github.com/jimytao/lexicon/releases/download/v0.9.14/Lexicon_0.9.14_x64-setup.exe)** (recommended, supports in-app auto updates)
- **[Lexicon_0.9.14_x64_en-US.msi](https://github.com/jimytao/lexicon/releases/download/v0.9.14/Lexicon_0.9.14_x64_en-US.msi)** (MSI Package)

### macOS Desktop (v0.9.14)
- **[Lexicon_0.9.14_universal.dmg](https://github.com/jimytao/lexicon/releases/download/v0.9.14/Lexicon_0.9.14_universal.dmg)** (Universal binary supporting Apple Silicon M1-M4 & Intel Macs)
...
### Android (v0.9.14)
- **[Lexicon_0.9.14_universal_signed.apk](https://github.com/jimytao/lexicon/releases/download/v0.9.14/Lexicon_0.9.14_universal_signed.apk)** (recommended, supports in-app auto update checks)
- For ABI splits, see [Releases v0.9.14](https://github.com/jimytao/lexicon/releases/tag/v0.9.14).
