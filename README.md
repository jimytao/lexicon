...
### Windows
- **[Lexicon_0.9.4_x64-setup.exe](https://github.com/jimytao/lexicon/releases/download/v0.9.4/Lexicon_0.9.4_x64-setup.exe)**（推荐，NSIS）
- **[Lexicon_0.9.4_x64_en-US.msi](https://github.com/jimytao/lexicon/releases/download/v0.9.4/Lexicon_0.9.4_x64_en-US.msi)**（MSI）

### Android
- **[Lexicon_0.9.4_universal_signed.apk](https://github.com/jimytao/lexicon/releases/download/v0.9.4/Lexicon_0.9.4_universal_signed.apk)**（推荐）
- 架构分包见 [Releases v0.9.4](https://github.com/jimytao/lexicon/releases/tag/v0.9.4)。
