...
- **批量导入与并行翻译**：支持一次性导入多张英汉/日汉漫画、教材截图或讲义，并行 OCR 与 AI 翻译。
...
### Windows
- **[Lexicon_0.9.11_x64-setup.exe](https://github.com/jimytao/lexicon/releases/download/v0.9.11/Lexicon_0.9.11_x64-setup.exe)**（推荐，支持软件内自动更新）
- **[Lexicon_0.9.11_x64_en-US.msi](https://github.com/jimytao/lexicon/releases/download/v0.9.11/Lexicon_0.9.11_x64_en-US.msi)**（MSI 安装包）

### macOS 桌面端 (v0.9.11)
- **[Lexicon_0.9.11_universal.dmg](https://github.com/jimytao/lexicon/releases/download/v0.9.11/Lexicon_0.9.11_universal.dmg)**（通用二进制，原生支持 Apple Silicon M1-M4 及 Intel Mac）
...
### Android 手机 / 平板 (v0.9.11)
- **[Lexicon_0.9.11_universal_signed.apk](https://github.com/jimytao/lexicon/releases/download/v0.9.11/Lexicon_0.9.11_universal_signed.apk)**（推荐通用包，支持软件内自动检测升级）
- 更多架构分包请见 [Releases v0.9.11](https://github.com/jimytao/lexicon/releases/tag/v0.9.11)。
