...
export const AI_CHAT_COMPOSER_LAYOUT = {
  /** Outer row: bulb + textarea + Send always share one row; items-end keeps Send beside the last line */
  ...
  input: 'flex-1 min-w-0 text-sm border border-gray-200 dark:border-gray-700 rounded-xl px-3 py-2 outline-none focus:border-violet-400 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-400 disabled:opacity-60 resize-none max-h-32 overflow-y-auto no-scrollbar leading-relaxed',
