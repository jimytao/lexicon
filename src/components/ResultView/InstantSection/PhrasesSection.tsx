    ...
    <div className="mb-4">
      ...
      <div className="space-y-1.5">
        {visible.map((p) => (
          <button
            ...
            className="w-full flex items-start justify-between gap-2 text-left px-2 py-1.5 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
          >
      ...
      {needsCollapse && (
        <button
          ...
          className="mt-2 flex items-center gap-1 text-xs text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 transition-colors px-2"
        >
          <svg
