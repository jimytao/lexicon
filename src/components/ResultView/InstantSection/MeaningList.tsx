                  ...
                  {m.imageQuery && (
                    <div className="mt-2.5">
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-accent/5 dark:bg-accent/10 border border-accent/10 hover:bg-accent/10 text-[10px] font-bold text-accent transition-all duration-300 cursor-pointer"
                      >
