  ...
  return (
    <div className="mb-4">
      <div className="flex items-center gap-1.5 mb-3">
        ...
        <h2 className="text-xs font-semibold text-indigo-900 dark:text-indigo-300">{t('practice.heading')}</h2>
            ...
            return (
              <div key={i} className="rounded-xl border border-gray-100 dark:border-gray-800 p-3">
                <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">
                  <span className="font-semibold text-gray-700 dark:text-gray-300 mr-1">{t('practice.scenario')} {i + 1}</span>
                  {ex.scenario}
                </p>
                <textarea
                  rows={2}
