          ...
          {data.items.map((item) => {
            ...
            return (
              <div
                ...
                className="group relative rounded-2xl p-5 bg-accent-soft border border-accent/10 hover:border-accent/20 transition-all duration-300 animate-in fade-in duration-300"
              >
                {isItemLoading && (
